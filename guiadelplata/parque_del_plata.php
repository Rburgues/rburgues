<!DOCTYPE html>
    ...
    <head>
        ...
        <!--=============== CSS ===============-->
        <link rel="stylesheet" href="parque_del_plata/styles.css">
    ...
    <body >
        ...
        <header class="container">
            <h1 style="margin-bottom:35px;">Parque del Plata</h1>
            <div class="tarjeta_comercios">COMERCIOS
            </div>
            <div class="espacio"></div>
            <div class="tarjeta_servicios">SERVICIOS
            </div>
            <div class="espacio"></div>
            <div class="tarjeta_eventos">EVENTOS
            </div>
        </header>
